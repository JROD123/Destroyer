...
function init()
{
    ...
    renderer.setClearColor(0x7d7b3d)
    ...
    var light3 = new THREE.SpotLight(0xffffff, 0.55);
    scene.add(light3);
    ...
    var Dirlight = new THREE.DirectionalLight(0xe5fbf9, 0.52);
    scene.add(Dirlight);
    ...
    loader.load("Destroyer.glb", handle_load);
